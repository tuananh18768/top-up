...
const DetailOrder = () => {
    return (
        <div className={cx('detail_order_shipping')}>
        <div className='row'>
            <div className='col-9'>
        ...
        <div className='row'>
            <div className='col-12'>
                <div className='d-flex'>
                    ...
                    <div><p style={{ fontSize: '25px', fontWeight: 'bold' }}>[Order_ID] + <Button type="primary">Delivery</Button></p>
                ...
                <div className='border border-secondary mt-2'>
                    <div className="card border-0">
                        <div className="card-body">
                            ...
                            <p className="card-text">Status: <Button type="primary">Delivery</Button></p>
